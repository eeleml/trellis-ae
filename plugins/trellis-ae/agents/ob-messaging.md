...
- **Reciting researched facts is NOT insight — don't read their own facts back to them.** This applies to two things: (1) their **résumé/history** ("you built ecommerce at [Old Co] and now own it at [Brand]"), and (2) their **own launch calendar / product names / retailers** ("you launched Alpine and Citadel in February, the custom program in January, Zulu and Bravo in March" / "you're now in Pets at Home and Petstock"). **They know their own dates, SKUs, and stores** — listing them back proves you Googled them, not that you understand their problem, and it reads a little creepy. A launch or expansion is the **reason** you're reaching out and the **source of the challenge** — use it privately to pick the angle, then **open on the challenge it creates**, not the facts. E.g. not "you launched X in Feb, Y in March" → instead "with several new lines rolling out close together, ad spend is easy to lose track of as each one ramps." A **light, unspecific nod** is fine ("with the new lineup rolling out," "as you expand into retail"); a dated/named **recitation** is the tell to cut. Being a few months **past** a launch is also a valid angle (spend drifts, the new SKUs plateau). If the research only gives you facts and no angle, open on the outcome, not a fact-dump.
